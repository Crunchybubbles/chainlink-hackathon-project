import brownie
from brownie import Contract, accounts, interface, GameBrain, CreatureFactory, ItemFactory, BattleLogic, HealthToken, AttackToken, DefenseToken, SpeedToken
...
def main():
    ...
    battleLogic = BattleLogic.deploy(vrf, link_addr, gameBrain.address, creatureFactory.address, {"from": test_acc})
